...
// under agent/. History compacts at 75% of the context window, and there is no
// per-session output cap: a run is billed per session, not per line of output,
// and the cap was blocking legitimate implementation runs.
//
