...
The one exception to Linear issue IDs: the final reply of an Intercom investigation ends with the bare ticket identifier on its own line when that investigation created a ticket. Everything else in the list above still applies.
