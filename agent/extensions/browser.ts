 ...
 *   runtime only relays commands, and the app preloads no credentials, cookies, or saved
 *   authentication state into the browser (the extension exposes no tools for them either).
 *   agent-browser is
