 ...
 * never exposed to the model. Configured intake-only channels mapped to
 * billing or Intercom workflows use the separate restricted-key root tool so
 * they do not depend on the requester's OAuth grant. Read-only by tool allowlist, built
