...
Work quickly and stop as soon as you have enough to answer or to conclude you cannot. Return the findings object as your final output; do not narrate a summary instead of returning it. Do not browse the web or fetch pages. If a source you need is unavailable, record that limitation and set needsHuman true rather than retrying or exploring further.`;
};
