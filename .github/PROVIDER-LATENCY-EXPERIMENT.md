...
Message delivery alone does not prove a turn started. Confirm the actual run and model requests before recording baseline timing.
...
No routing recommendation is established yet. The historical 72 requests totaling 62m 44.66s were timestamp/context correlations, not exact generation-to-step joins. Unrelated instruction, critic, cancellation, and runtime fixes remain outside this first comparison.
