...
- Slack channel IDs listed in `SLACK_INTAKE_ONLY_CHANNELS` are intake-only: mentions there stay trusted but are routed to Linear instead of running coding work.
